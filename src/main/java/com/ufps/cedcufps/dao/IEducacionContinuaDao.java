...
public interface IEducacionContinuaDao extends JpaRepository<EducacionContinua, Long> {
	...
	@Query(value= "SELECT * FROM educacion_continua ec where ec.estado='Activo' or ec.estado='En Desarrollo' and ec.imagen is not null ORDER BY ec.id DESC LIMIT 5",nativeQuery = true)
