...
function aprobarPreinscripcionAll(){
	...
	swal("Está seguro de aprobar todas las preinscripciones?",  {
		  buttons: {
		    cancel: "Cancelar",
		    aceptar: {
		      text: "Aceptar",
...
function notificarPreinscripcionAllParticipantes(){
	...
	swal("Está seguro de notificar todos los participantes?",  {
		  buttons: {
		    cancel: "Cancelar",
		    aceptar: {
		      text: "Aceptar",
		  ...
		  switch (value) {
		    ...
		    case "aceptar":
		    	 $.ajax({
		           ...
		           cache: !1,
		           success: function (t) {
		               toastr.success("Se ha notificado la inscripción a los participantes exitosamente", "Excelente!", { positionClass: "toast-top-right", preventDuplicates: !0 });
		           },
		           error: function (a) {},
		       });
		      break;
...
function generarEmailsTxt(nombreEducacionContinua, fechaEducacionContinua, idAccesoEducacionContinua){
	let a = document.createElement("a");
	swal("¿Seleccione los asistentes de los cuáles dese generar los emails?",  {
		  buttons: {
		    cancel: "Cancelar",
		    todos: {
		      text: "Todos",
		...
		.then((value) => {
		  switch (value) {
		    ...
		    case "inscripcionAprobada":
		    	
		        a.setAttribute("href", contextPath + "/educacion-continua/email-participantes?educacionContinua="+nombreEducacionContinua+"&fecha="+fechaEducacionContinua+"&id="+idAccesoEducacionContinua+"&all=false");
		        a.click();
		      break;
		    case "todos":
		    	
		        a.setAttribute("href", contextPath + "/educacion-continua/email-participantes?educacionContinua="+nombreEducacionContinua+"&fecha="+fechaEducacionContinua+"&id="+idAccesoEducacionContinua);
		        a.click();
		      break;
		  }
		});
