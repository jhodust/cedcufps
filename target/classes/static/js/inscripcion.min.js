...
function creacionTarjetaInscripcion(n) {
    ...
    var s = t + " " + a,
        l = null,
        p = null,
        d = (c.getUTCDate() < 10 ? "0" + c.getUTCDate() : c.getUTCDate()) + " " + meses[c.getUTCMonth()] + " " + c.getUTCFullYear();
    (l = c.getUTCHours() < 10 ? "0" + c.getUTCHours() : c.getUTCHours()), (p = c.getUTCMinutes() < 10 ? "0" + c.getUTCMinutes() : c.getUTCMinutes());
    var f = null;
    f = c.getUTCHours() <= 11 ? l + ":" + p + " A.M" : 12 == c.getUTCHours() ? l + ":" + p + " M" : l + ":" + p;
