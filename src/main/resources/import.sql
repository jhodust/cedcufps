...
insert into educacion_continua(id,nombre,fecha_inicio,fecha_fin,fecha_lim_inscripcion,cant_max_participantes,costo_inscripcion,duracion,id_tipo_educacion_continua,imagen,id_docente,id_programa,consecutivo,id_clasificacion_cine,lugar,estado,costo_educacion_continua,porcentaje_asistencia,id_acceso,info_adicional) values(18,'II IngenierÃ­a Civil','2020-08-10','2020-08-13','2020-08-09','10','100000','70',1,'files/uploads/educacion-continua/8/portada.jpg',32,5,'002',412,'Hotel Bolivar Salon Principal','Activo','53737',15,'1608778444475','INFOOOOOOOOO');
