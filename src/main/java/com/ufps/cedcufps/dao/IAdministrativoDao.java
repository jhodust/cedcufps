...
public interface IAdministrativoDao extends JpaRepository<Administrativo, Long>{
	...
	@Transactional
	@Modifying
	@Query(value = "INSERT INTO administrativos (dependencia, cargo, id_persona) VALUES(?1,?2,?3) ON DUPLICATE KEY  UPDATE dependencia=VALUES(dependencia), cargo=VALUES(cargo)", nativeQuery = true)
